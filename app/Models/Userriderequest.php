...
class Userriderequest extends Model
{
    ...
    protected $fillable = [
        ...
        'is_homeDelivery',
        'is_needHelp',
        'requirement_transport_license',
        'requirement_transport_license_level',
        'requirement_insurance',
        'requirement_insurance_level',
        'requirement_identity',
        'requirement_identity_level',
        'requirement_vehicle',
        'requirement_vehicle_level',
        'requirement_equipment',
        'requirement_equipment_level',
        'requirement_loading_help',
        'requirement_loading_help_level',
        'status',
        'message',
    ];
