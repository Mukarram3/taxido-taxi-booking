        ...
        <div class="illustration-side">
            <div class="illustration-content">
                ...
                <h1 class="illustration-title">
                    <span class="lang-content fr active">Bienvenue, Expéditeur !</span>
                    <span class="lang-content en">Welcome, Shipper!</span>
                </h1>
                <p class="illustration-subtitle">
                    <span class="lang-content fr active">Envoyez vos colis en toute sécurité et économisez jusqu'à 70%</span>
                    <span class="lang-content en">Send your packages safely and save up to 70%</span>
                </p>
        ...
        <div class="form-side">
            ...
            <div class="form-container">
                <div class="form-header">
                    <h2 class="form-title">
                        <span class="lang-content fr active">Connexion Expéditeur</span>
                        <span class="lang-content en">Shipper Login</span>
                    </h2>
                ...
                <form id="loginForm" method="POST" action="{{route('user.login')}}">
                    ...
                    <div class="form-options">
                        ...
                        <a href="{{url('user/forgot-password')}}" class="forgot-link">
                ...
                <div class="social-buttons">
                    <a href="{{ url('user/auth/google') }}" style="text-decoration: none" class="btn-social">
                        <span>🔵</span>
                        <span>Google</span>
                    </a>
                ...
                <div class="switch-mode">
                    <p class="switch-mode-text">
                        <span class="lang-content fr active">Vous êtes transporteur ?</span>
                        <span class="lang-content en">Are you a carrier?</span>
                        <a href="{{ url('driver/login') }}" class="switch-mode-link">
