...
@endphp
    ...
    <div class="main-container">
        ...
        <div class="breadcrumb">
            ...
            <span>›</span>
            <span style="color: var(--dark);">{{ $ride_booked->pickup_city }} → {{ $ride_booked->destination_city }}</span>
        </div>

        <!-- Header Card -->
        <div class="header-card">
            <div class="status-badge">
                🔥 <span class="lang-content fr active">{{ $ride_booked->message }}</span>
                <span class="lang-content en">{{ $ride_booked->message }}</span>
            </div>
            ...
            <div class="route-summary">
                <div class="route-point">
                    ...
                    <div class="route-city">📍 {{ $ride_booked->pickup_city }}</div>
                    <div class="route-date">{{ \Carbon\Carbon::parse($ride_booked->pickup_date)->translatedFormat('d F Y • ~H:i') }}</div>
                </div>
                ...
                <div class="route-point">
                    ...
                    <div class="route-city">📍 {{ $ride_booked->destination_city }}</div>
                    <div class="route-date">{{ \Carbon\Carbon::parse($ride_booked->delivery_date)->translatedFormat('d F Y • ~H:i') }}</div>
                </div>
            </div>
            ...
            <div class="info-grid">
                <div class="info-item">
                    ...
                    <div class="info-text">
                        ...
                        #{{ $ride_booked->reference_id }}
                    </div>
                </div>
                <div class="info-item">
                    <div class="info-icon">⏰</div>
                    <div class="info-text">
                        <span class="lang-content fr active">Expire le {{ \Carbon\Carbon::parse($ride_booked->expiry_date)->format('d/m/y') }}</span>
                        <span class="lang-content en">Expires {{ \Carbon\Carbon::parse($ride_booked->expiry_date)->format('d/m/y') }}</span>
                    </div>
                </div>
                <div class="info-item">
                    <div class="info-icon">📏</div>
                    <div class="info-text">~{{ $ride_booked->distance }} km</div>
                </div>
                @php
                    $now = \Carbon\Carbon::now();
                    $expiry = \Carbon\Carbon::parse($ride_booked->expiry_date);
                    ...
                    $transportName = ucfirst(strtolower($ride_booked->vehicle_type_needed ?? ''));
                    $icon = $icons[$transportName] ?? '❓';

                    $packages = json_decode($ride_booked->userriderequest->packages_json, true);
                ...
                <div class="info-item">
                    ...
                    <div class="info-text">
                        <span class="lang-content fr active">{{ $ride_booked->vehicle_type_needed }}</span>
                        <span class="lang-content en">{{ $ride_booked->vehicle_type_needed }}</span>
                    </div>
                </div>
                <div class="info-item">
                    <div class="info-icon">📅</div>
                    <div class="info-text">
                        <span class="lang-content fr active">{{ \Carbon\Carbon::parse($ride_booked->created_at)->diffForHumans() }}</span>
                        <span class="lang-content en">{{ \Carbon\Carbon::parse($ride_booked->created_at)->diffForHumans() }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content-layout">
            ...
            <div>
                ...
                <div class="card">
                    ...
                    <div class="package-header">
                        ...
                        <div class="package-info">
                            ...
                            @php
                               $packages_types = json_decode($ride_booked->type_of_package, true);
                    ...
                    <div class="specs-grid">
                        <div class="spec-box">
                            <div class="spec-value">{{ count(json_decode($ride_booked->type_of_package, true)) }}</div>
                    ...
                    <div class="description-box">
                        ...
                        <span class="lang-content fr active">
                            {{ $ride_booked->recipient_delivery_instructions }}
                        </span>
                        <span class="lang-content en">
                            {{ $ride_booked->recipient_delivery_instructions }}
                        </span>
                ...
                <div class="card">
                    ...
                    @php
                    $pictures = json_decode($ride_booked->parcel_pictures);
                    @endphp
                ...
                <div class="card">
                    ...
                    <div class="requirements-list">
                        @if($ride_booked->requirement_transport_license)
                        <div class="requirement-item @if($ride_booked->requirement_transport_license_level == 'mandatory') required @endif">
                            ...
                            @if($ride_booked->requirement_transport_license_level == 'mandatory')
                        ...
                        @endif
                            @if($ride_booked->requirement_insurance)
                        <div class="requirement-item @if($ride_booked->requirement_insurance_level) required @endif">
                            ...
                            @if($ride_booked->requirement_insurance_level)
                            <div class="requirement-badge">
                                <span class="lang-content fr active">Requis</span>
                                <span class="lang-content en">Required</span>
                            </div>
                            ...
                            @endif
                            @if($ride_booked->requirement_vehicle)
                        <div class="requirement-item @if($ride_booked->requirement_vehicle_level == 'mandatory') required @endif">
                            <div class="requirement-icon">🚛</div>
                            <div class="requirement-info">
                                <div class="requirement-title">
                            ...
                            @if($ride_booked->requirement_vehicle_level)
                                <div class="requirement-badge">
                                    <span class="lang-content fr active">Requis</span>
                                    <span class="lang-content en">Required</span>
                                </div>
                            ...
                            @endif
                            @if($ride_booked->requirement_loading_help)
                        <div class="requirement-item @if($ride_booked->requirement_loading_help_level) required @endif">
                            <div class="requirement-icon">💪</div>
                            <div class="requirement-info">
                                <div class="requirement-title">
                            ...
                            @if($ride_booked->requirement_loading_help_level)
                                <div class="requirement-badge">
                                    <span class="lang-content fr active">Requis</span>
                                    <span class="lang-content en">Required</span>
                                </div>
            ...
            <div class="sidebar">
                ...
                <div class="price-card">
                    ...
                    <div class="price-amount">{{ $ride_booked->fare }}€</div>
                ...
                <div class="destination-card">
                    ...
                    <div style="display: flex; align-items: center; gap: 12px; padding: 14px; background: var(--light); border-radius: var(--radius); margin-bottom: 12px;">
                        ...
                        <div style="flex: 1;">
                            <div style="font-weight: 700; color: var(--dark); margin-bottom: 2px;">{{ $ride_booked->user->firstName }} {{ strtoupper(substr($ride_booked->user->lastName, 0, 1)) }}
                                .</div>
                ...
                <div class="action-buttons">
                    ...
                    <form action="{{ url('driver/ride-verification/' . $ride_booked->id) }}" method="post">
                        @csrf
                        <input type="hidden" name="fare" value="{{ $ride_booked->fare }}">
                        ...
                        <button type="submit" class="btn btn-primary">
                            ✅ <span data-lang="fr" class="active"> Apply current offer ({{ $ride_booked->fare }}€)</span>
                        </button>
                    </form>

                    <a href="{{ url('driver/accept-ride/' . $ride_booked->id) }}" class="btn btn-outline">
                        💬 <span class="lang-content fr active">Négocier le tarif</span>
                        <span class="lang-content en">Negotiate price</span>
                    </a>
                </div>

                @if($ride_booked->requirement_transport_license && $ride_booked->requirement_transport_license_level == 'mandatory' && $ride_booked->requirement_insurance && $ride_booked->requirement_insurance_level == 'mandatory' )
                <!-- Alert -->
                <div class="alert-box">
                ...
                <div class="destination-card">
                    ...
                    <div class="address-box">
                        <div class="address-details">{{ $ride_booked->pickup_location }}</div>
                    </div>
                    <div style="font-size: 12px; color: var(--gray); padding: 0 14px;">
                        <strong>
                            <span class="lang-content fr active">Contact :</span>
                            <span class="lang-content en">Contact:</span>
                        </strong> {{ $ride_booked->user->firstName }} {{ $ride_booked->user->lasttName }}<br>
                        <strong>
                            <span class="lang-content fr active">Instructions :</span>
                            <span class="lang-content en">Instructions:</span>
                        </strong>
                        <span class="lang-content fr active">{{ $ride_booked->pickup_additional_info }}</span>
                        <span class="lang-content en">{{ $ride_booked->pickup_additional_info }}</span>
                    </div>
                </div>
                ...
                <div class="destination-card">
                    ...
                    <div class="address-box">
                        <div class="address-details">{{ $ride_booked->destination_location }}</div>
                    </div>
                    <div style="font-size: 12px; color: var(--gray); padding: 0 14px;">
                        <strong>
                            <span class="lang-content fr active">Destinataire :</span>
                            <span class="lang-content en">Recipient:</span>
                        </strong> {{ $ride_booked->receiver_name }}<br>
                        <strong>
                            <span class="lang-content fr active">Instructions :</span>
                            <span class="lang-content en">Instructions:</span>
                        </strong>
                        <span class="lang-content fr active">{{ $ride_booked->destination_additional_info }}</span>
                        <span class="lang-content en">{{ $ride_booked->destination_additional_info }}</span>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-list">
                        <div class="info-list-item">
                            <strong>🆔 <span class="lang-content fr active">Référence :</span><span class="lang-content en">Reference:</span></strong> #{{ $ride_booked->reference_id }}
                        </div>
                        <div class="info-list-item">
                            <strong>⏰ <span class="lang-content fr active">Expire le :</span><span class="lang-content en">Expires:</span></strong> {{ \Carbon\Carbon::parse($ride_booked->expiry_date)->format('d/m/y') }}
                        </div>
                        <div class="info-list-item">
