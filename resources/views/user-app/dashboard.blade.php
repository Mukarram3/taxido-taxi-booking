...
<body>
    ...
    <div class="main-container">
        ...
        <div class="proposals-list" id="proposalsList">
                    ...
                    <div class="transporter-info">
                        ...
                        <div class="transporter-details">
                            ...
                            <div class="transporter-rating">
                                ...
                                <span>4.9 (156 <span data-lang="fr" class="active">avis</span><span data-lang="en">reviews</span>)</span>
                            </div>
                            <div class="transporter-badges">
                                <span class="badge verified">✓ <span data-lang="fr" class="active">Vérifié</span><span data-lang="en">Verified</span></span>
                                <span class="badge">🛡️ <span data-lang="fr" class="active">Assuré</span><span data-lang="en">Insured</span></span>
                                <span class="badge">⚡ <span data-lang="fr" class="active">Pro</span><span data-lang="en">Pro</span></span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="proposal-card">
                ...
                <div class="proposal-header">
                    <div class="transporter-info">
                        ...
                        <div class="transporter-details">
                            ...
                            <div class="transporter-badges">
                                <span class="badge verified">✓ <span data-lang="fr" class="active">Vérifié</span><span data-lang="en">Verified</span></span>
                                <span class="badge">🚗 <span data-lang="fr" class="active">Particulier</span><span data-lang="en">Individual</span></span>
                            </div>
                        </div>
                    </div>
                    <div class="proposal-price">
                ...
                <div style="padding: 16px; background: var(--warning); background: linear-gradient(135deg, #fef3c7, #fed7aa); border-radius: var(--radius-lg); margin-bottom: 20px;">
            ...
            <div class="proposal-card">
                <div class="proposal-header">
                    <div class="transporter-info">
                        <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100"
                             ...
                             class="transporter-avatar">
                        <div class="transporter-details">
                            <div class="transporter-name">Marie K.</div>
                            <div class="transporter-rating">
                                <span class="rating-stars">⭐⭐⭐⭐⭐</span>
                            ...
                            <div class="transporter-badges">
                                <span class="badge verified">✓ <span data-lang="fr" class="active">Vérifié</span><span data-lang="en">Verified</span></span>
                                <span class="badge">🌟 <span data-lang="fr" class="active">Premium</span><span data-lang="en">Premium</span></span>
                                <span class="badge">🌱 <span data-lang="fr" class="active">Éco</span><span data-lang="en">Eco</span></span>
                            </div>
                        </div>
                    </div>
                    <div class="proposal-price">
                ...
                <div class="proposal-details">
                    <div class="detail-item">
                        <span class="detail-icon">🚐</span>
                        <span class="detail-text">Renault Master</span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-icon">🌱</span>
                        <span class="detail-text">
                ...
                <div class="proposal-actions">
                    ...
                    <button class="btn btn-warning" onclick="negotiateProposal(3)">
                        💬 <span data-lang="fr" class="active">Négocier</span>
                        <span data-lang="en">Negotiate</span>
                    </button>
    ...
    <script>
        ...
        function filterProposals(filter) {
            ...
            // Here you would filter the actual proposals
