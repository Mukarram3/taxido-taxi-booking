        ...
        <div class="custom-container">
            <div class="accept-ride-details-box mt-3">
                <div class="my-ride-details-page p-0 mt-0">
                    ...
                    @php
                        $means = json_decode($ride_detail->means_of_transport, true);
                        $destination_location = json_decode($ride_detail->destination_location, true);
                    ...
                    <div class="d-flex align-content-center justify-content-between mt-2">
                        <h6 class="content-color fw-normal">Sub Type of Package</h6>
                        <h5 class="title-color fw-normal">{{ $ride_detail->packagesubtype?->title }}</h5>
                    </div>
                    <div class="d-flex align-content-center justify-content-between mt-2">
                    ...
                    <div class="d-flex align-content-center justify-content-between mt-2">
                        <h6 class="content-color fw-normal">Mean of Transports</h6>
                        <h5 class="title-color fw-normal">{{ is_array($meanNames) ? implode(', ', $meanNames) : '' }}</h5>
                    </div>
                    <div class="d-flex align-content-center justify-content-between mt-2">
                        <h6 class="content-color fw-normal">Departure Date</h6>
                        <h5 class="title-color fw-normal">{{ $ride_detail->departure_date }}</h5>
                    </div>
                    <div class="d-flex align-content-center justify-content-between mt-2">
                        <h6 class="content-color fw-normal">Expiry Date</h6>
                        <h5 class="title-color fw-normal">{{ $ride_detail->expiry }}</h5>
                    </div>
                    <div class="d-flex align-content-center justify-content-between mt-2">
                    ...
                    <div class="d-flex flex-row">
                        @php
                            $parcel_pictures = $ride_detail->parcel_pictures ? json_decode($ride_detail->parcel_pictures) : '';
                        @endphp
                        @if($parcel_pictures)
