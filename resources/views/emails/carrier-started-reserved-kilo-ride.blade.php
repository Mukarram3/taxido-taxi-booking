...
<head>
    ...
    <title>Carrier Started - Reserved Kilo Ride - JeConfie</title>
</head>
                ...
                <tr>
                    <td align="center" style="padding: 20px 30px 0 30px;">
                        <table cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                <td bgcolor="#2ecc71" style="background-color: #2ecc71; color: #ffffff; padding: 10px 30px; border-radius: 25px; font-weight: bold; font-size: 14px;">
                                    🚚 Carrier En Route
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td style="padding: 40px 30px 30px 30px;">
                        ...
                        <p style="color: #555555; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                            Your ride has been <strong>started</strong> and the carrier is on the way to the destination address.
                        </p>
                    </td>
                </tr>
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="background-color: #e8f5e9; border-left: 4px solid #2ecc71; padding: 20px; border-radius: 5px;">
                                    <h3 style="color: #2ecc71; font-size: 18px; margin: 0 0 15px 0;">
                                        📍 Route Information
                                    </h3>
                ...
                <tr>
                    <td style="padding: 0 30px 30px 30px;">
                        <p style="color: #7f8c8d; font-size: 14px; line-height: 1.6; margin: 0; text-align: center;">
                            Thank you for using our service. You can track your delivery in real-time from your dashboard.
                        </p>
                    </td>
                </tr>
