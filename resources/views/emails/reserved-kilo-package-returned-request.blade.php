...
<p>Carrier {{ $ride->user->name }} has returned the Parcel and awaiting confirmation for reserved kilo package return of your ride from
    ...
    to
    <strong>{{ is_array($ride->driverriderequest->destination_location) ? implode('-> ', $ride->driverriderequest->destination_location) : $ride->driverriderequest->destination_location }}</strong></p>
<ul>
