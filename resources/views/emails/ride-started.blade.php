...
<head>
    ...
    <title>🚚 Le transporteur est en route pour la récupération - JeConfie</title>
    <style>
        body {
...
<div class="container">
    ...
    <!-- Contenu -->
    <div class="content">
        <h2 style="color: #2c3e50; font-size: 22px; margin-bottom: 20px;">🚚 Le transporteur est en route pour récupérer votre colis</h2>

        <p>Bonjour <strong>{{ $ride->user->firstName . ' ' . $ride->user->lastName }}</strong>,</p>

        <p>Votre colis prévu de <strong>{{ $ride->pickup_location }}</strong> à <strong>{{ $ride->destination_location }}</strong> a été programmé.
            Le transporteur est actuellement en route pour récupérer votre colis.
            Merci de le préparer afin de faciliter la prise en charge.</p>
        ...
        <p>Merci d’utiliser notre service. Vous pouvez suivre l’état d’avancement de votre envoi directement depuis votre application.</p>
