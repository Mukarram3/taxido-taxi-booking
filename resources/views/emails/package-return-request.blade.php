                ...
                <tr>
                    <td align="center" style="padding: 0 30px 30px 30px;">
                        <table cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                <td align="center" bgcolor="#28a745" style="background-color: #28a745; border-radius: 5px; padding: 14px 40px;">
                                    <a href="{{ $packageReturnedlLink }}" style="color: #ffffff; text-decoration: none; font-weight: bold; font-size: 15px; display: block;">
