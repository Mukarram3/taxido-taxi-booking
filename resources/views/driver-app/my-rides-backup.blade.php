                    ...
                    <ul class="my-ride-list driver-ride-list p-1" style="border: 2px solid orange; border-radius: 8px;">
                        ...
                        <div class="custom-card">
                            <div class="custom-header">
                                <span>👤 Martin Asero</span>
                                <span>€300</span>
                            </div>
                            <div><span class="custom-label">📅 Posted on:</span> Sept 01, 2025</div>
                            ...
                            <div class="custom-section">
                                <div>🔹 <span class="custom-label">Airline:</span> Air France</div>
                                <div>🔹 <span class="custom-label">Available:</span> 15 kg | <span class="custom-label">Reserved:</span> 10 kg</div>
                                <div>🔹 <span class="custom-label">Price per kg:</span> €30</div>
                                <div>📅 <span class="custom-label">Departure:</span> Sept 10, 2025 - 12:00</div>
                                <div>📅 <span class="custom-label">Arrival:</span> Sept 10, 2025 - 14:00</div>
                                <div>📅 <span class="custom-label">Expiration:</span> Sept 19, 2025</div>
                                <div>🛡️ <span class="custom-label">Reception:</span> hand-to-hand</div>
                            </div>

                            <div class="custom-section text-center">
                                ✈️ Paris CDG ⟶ Lyon St-Exupéry
                            </div>

                            <div class="custom-footer">
                                <!-- Contact dropdown -->
                                <div class="dropdown">
                                    <a class="dropdown-toggle text-decoration-none text-black" href="#" role="button" id="contactDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="bi bi-telephone-fill text-success"></i> Contact
                                    </a>
                                    <ul class="dropdown-menu" aria-labelledby="contactDropdown">
                                        <li><a class="dropdown-item" href="#">📞 Contact Receiver</a></li>
                                        <li><a class="dropdown-item" href="#">📞 Contact Sender</a></li>
                                    </ul>
                                </div>

                                <!-- Message stays same -->
                                <span class=""><i class="bi bi-chat-dots-fill text-success"></i> Message</span>
                            ...
                            <div class="text-center my-3">
                                <button class="btn btn-danger">🔴 Cancel Transport</button>
                            </div>
                        </div>
                            ...
                            <li class="white-background">
                                <div class="my-ride-box">
                                    <div class="my-ride-head">
                                        <a href="#" class="my-ride-img">
                                            <img class="img-fluid profile-img"
                                                 src="{{ $active_ride->user->profile ? asset('storage/'.$active_ride->user->profile) : asset('assets/images/profile/p5.png')}}"
                                                 alt="p5">
                                        </a>
                                        ...
                                        <div class="my-ride-content flex-column">
                                            <div class="flex-spacing">
                                                ...
                                                <span
                                                    class="badge badge-success text-white">{{ $active_ride->created_at }}</span>
                                    ...
                                    <div class="my-ride-details">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item"
                                                               href="tel:{{ $active_ride->user->phone }}">📞 Call
                                                                Sender</a></li>
                                                        <li><a class="dropdown-item"
                                                               href="tel:{{ $active_ride->receiver_phone }}">📞 Call
                                                                Receiver</a></li>
                                                    </ul>
                                                </div>
                                        ...
                                        @php
                                            $means = json_decode($active_ride->means_of_transport, true);
                                            $destination_location = json_decode($active_ride->destination_location, true);
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            {{--                                            <p>Departure Date :- {{ $active_ride->departure_date }}</p>--}}
                        ...
                        @endforeach
                            @foreach($active_reserved_kilo_rides as $active_reserved_kilo_ride)
                                @php
                                    $message = $active_reserved_kilo_ride->message;
                                    $badgeClass = 'badge'; // base class
                                    $badgeText = '';
                                ...
                                <li>
                                    <div class="my-ride-box">
                                        <div class="my-ride-head d-flex align-items-center w-100" style="min-width: 0;">
                                            ...
                                            <a href="#" class="my-ride-img flex-shrink-0">
                                                <img class="img-fluid profile-img"
                                                     ...
                                                     src="{{ $active_reserved_kilo_ride->driver->profile ? asset('storage/'.$active_reserved_kilo_ride->driver->profile) : asset('assets/images/profile/p5.png')}}"
                                                     alt="p5">
                                            </a>
                                            ...
                                            <div class="d-flex align-items-center flex-grow-1 ms-2" style="min-width: 0;">
                                                ...
                                                <h6 class="title-color fw-medium mb-0 me-2 flex-shrink-0">
                                                    {{ $active_reserved_kilo_ride->driver->name }}
                                                </h6>
                                                ...
                                                <h5 class="fw-medium success-color mb-0 flex-shrink-0 ms-2">
                                                    {{ $active_reserved_kilo_ride->driverriderequest->price_currency }}{{ $active_reserved_kilo_ride->price_per_kilo }}
                                                    /Kilo
                                                </h5>
                                            </div>
                                        </div>

                                        <span class="{{ $badgeClass }} mt-2">{{ $active_reserved_kilo_ride->message }}</span>

                                        <div class="my-ride-details">
                                            <div class="ride-info">
                                                <div>
                                                    <h6 class="fw-normal title-color">{{ \Carbon\Carbon::parse($active_reserved_kilo_ride->date_and_time_of_followup)->format('Y d M H:i:s') }}</h6>
                                                    <h6 class="fw-normal title-color">{{ $active_reserved_kilo_ride->driverriderequest->distance }} km</h6>
                                                </div>
                                                <div class="flex-align-center gap-2">
                                                    <a href="{{url('driver/chatting')}}">
                                                        <img class="img-fluid communication-icon"
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                   href="tel:{{ $active_reserved_kilo_ride->user->phone }}">📞 Call
                                                                    Sender</a></li>
                                                            <li><a class="dropdown-item"
                                                                   href="tel:{{ $active_reserved_kilo_ride->userfarerequest->receiver_phone }}">📞 Call
                                                                    Receiver</a></li>
                                                        </ul>
                                                    </div>
                                                    <a href="{{url('driver/reserved-kilo-ride-details?ride_id='.$active_reserved_kilo_ride->id)}}">
                                                        <img src="{{ asset('public/assets/images/view-detail-image.png') }}"
                                                             title="View package details" width="30px" alt="loading">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="d-flex flex-column">
                                                @if($active_reserved_kilo_ride->driverriderequest->airline)
                                                    <p><span class="fw-bold">Travel Company</span>
                                                        :- {{ $active_reserved_kilo_ride->driverriderequest->airline }}</p>
                                                @endif
                                                @if($active_reserved_kilo_ride->driverriderequest->maritimes)
                                                    <p><span class="fw-bold">Travel Company</span>
                                                        :- {{ $active_reserved_kilo_ride->driverriderequest->maritimes }}</p>
                                                @endif
                                                <p><span class="fw-bold">Available Transport Capacity</span>
                                                    :- {{  $active_reserved_kilo_ride->driverriderequest->available_transport_capacity }}</p>
                                                <p><span class="fw-bold">Number of Kilos Reserved</span>
                                                    :- {{ $active_reserved_kilo_ride->driverriderequest->total_transport_capacity - $active_reserved_kilo_ride->driverriderequest->available_transport_capacity }}</p>
                                                <p><span class="fw-bold">Departure Date</span>
                                                    :- {{ $active_reserved_kilo_ride->driverriderequest->departure_datetime->format('Y d M H:i:s') }}</p>
                                                <p><span class="fw-bold">Arrival Date</span>
                                                    :- {{ $active_reserved_kilo_ride->driverriderequest->arrival_datetime?->format('Y d M H:i:s') }}</p>
                                                <p><span class="fw-bold">Expiry Date</span>
                                                    :- {{ $active_reserved_kilo_ride->driverriderequest->end_reservation_date?->format('Y d M H:i:s') }}</p>
                                                <p><span class="fw-bold">method of reception</span>
                                                    :- {{ $active_reserved_kilo_ride->driverriderequest->package_receiving_method }}</p>
                                            </div>
                                            <ul class="ride-location-listing">
                                                <li class="border-0 shadow-none">
                                                    <div class="location-box">
                                                        <img class="icon"
                                                             src="{{asset('assets/images/svg/location-fill.svg')}}"
                                                             alt="location">
                                                        <h5 class="fw-light title-color">{{ $active_reserved_kilo_ride->driverriderequest->pickup_location }}</h5>
                                                    </div>
                                                </li>
                                                @foreach($active_reserved_kilo_ride->driverriderequest->destination_location as $location)
                                                    <li class="border-0 shadow-none">
                                                        <div class="location-box">
                                                            <img class="icon bg-transparent"
                                                                 src="{{asset('assets/images/svg/gps.svg')}}" alt="gps">
                                        ...
                                        @if(trim($active_reserved_kilo_ride->message) === 'delivery in progress')
{{--                                            <a href="{{ url('driver/track-ride/'. $active_ride->id) }}"--}}
{{--                                               class="btn btn-yellow w-100 auth-btn mt-3">GPS navigation for Parcel--}}
{{--                                                Delivery</a>--}}
                                            <a href="{{url('driver/reserved-kilo-ride-complete-request/'.$active_reserved_kilo_ride->id)}}"
                                               class="btn btn-primary w-100 mt-3">Complete delivery</a>
                                        @endif
                                        @if($active_reserved_kilo_ride->status == 'carrier_cancelled_ride' || $active_reserved_kilo_ride->status == 'active')
                                            {{--                                        @if($active_ride->message != 'Parcel returned')--}}
                                            @if($active_reserved_kilo_ride->message == 'Delivery in progress, parcel return requested' || $active_reserved_kilo_ride->message == 'Carrier Cancelled Ride' || $active_reserved_kilo_ride->message == 'User Cancelled Ride')
{{--                                                <a href="{{url('driver/start-parcel-return/'.$active_reserved_kilo_ride->id)}}"--}}
{{--                                                   class="btn btn-warning w-100 mt-3">Start Parcel Return</a>--}}
                                            @elseif($active_reserved_kilo_ride->message == "Package return in progress")
{{--                                                <a href="{{ url('driver/track-ride/'. $active_ride->id) }}"--}}
{{--                                                   class="btn btn-yellow w-100 auth-btn mt-3">GPS navigation for Parcel--}}
{{--                                                    Return</a>--}}
{{--                                                <a href="{{url('driver/package-returned-request/'.$active_reserved_kilo_ride->id)}}"--}}
{{--                                                   class="btn btn-warning w-100 mt-3">Parcel Returned</a>--}}
                                            @elseif($active_reserved_kilo_ride->message == 'Parcel returned')
                                            @elseif(trim($active_reserved_kilo_ride->message) !== 'transport completed awaiting validation')
                                                <a href="#reasons" data-bs-toggle="offcanvas"
                                                   data-id="{{ $active_reserved_kilo_ride->id }}"
                                                   class="btn btn-danger w-100 mt-3 cancel_rideBtn">Cancel the Transport</a>
                                            @endif
                                        @endif
                                    </div>
