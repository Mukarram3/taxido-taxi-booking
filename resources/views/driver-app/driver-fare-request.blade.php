...
@section('content')
    ...
    @php
        $driverriderequest = \App\Models\Driverriderequest::find($rideRequest);
    @endphp
...
{{--        <script src="{{asset('assets/js/custom-map.js')}}"></script>--}}
        ...
        <script>
            ...
            const userRequestId = {{ $rideRequest }};
            ...
            function initMap() {
                ...
                function getDriverFareRequest() {
                    $.ajax({
                        url: `/driver/get-user-fare-request?driverriderequest_id=${userRequestId}`,
                        method: 'GET',
