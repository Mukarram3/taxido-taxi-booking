...
<head>
    ...
    <meta name="description" content="JeConfie Driver Signup">
    <meta name="keywords" content="jeconfie, driver, carrier, signup">
    <meta name="author" content="JeConfie">
    <link rel="manifest" href="{{ asset('manifest.json') }}">
    <link rel="icon" href="{{asset('assets/images/logo/favicon.png')}}" type="image/x-icon">
    <title>Create Driver Account - JeConfie</title>
    ...
    <div class="signup-container">
        <div class="signup-card">
            ...
            <div class="progress-container">
                ...
                <div class="progress-title" id="progress-title">Profile Photo</div>
            </div>

            <!-- SIGNUP HEADER -->
            <div class="signup-header">
                <h1 class="signup-title">Join JeConfie as Driver</h1>
                <p class="signup-subtitle">Create your account and start delivering with confidence</p>
            </div>
            ...
            <form action="{{url('driver/otp')}}" method="POST" id="signup-form">
                ...
                <div class="step-section" id="step-section-6">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            <select id="travel-frequency" name="travelFrequency" class="form-select">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="destinations" name="destinations" class="form-textarea" placeholder="List your usual destinations (ex: Paris, London, New York...)"></textarea>
                        </div>
                    </div>
...
<script>
    // ===== GLOBAL VARIABLES =====
    const CONFIG = {
        STEP_TITLES: ['', 'Profile Photo', 'Personal Info', 'Email Verification', 'Check Email', 'Phone Verification', 'Preferences', 'Complete Setup'],
        MAX_PHOTO_SIZE_MB: 2,
        RESEND_COUNTDOWN_SECONDS: 60,
        URLS: {
            SEND_EMAIL: '{{ url("driver/send-verification-email") }}',
    ...
    async function completeSignup() {
        ...
        try {
            ...
            if (selectedExperience) {
                formData.append('experience', selectedExperience.dataset.experience);
            }

            const selectedTransports = document.querySelectorAll('.transport-pref.selected');
            selectedTransports.forEach((el, i) => {
                formData.append(`transports[${i}]`, el.dataset.transport);
            });
    ...
    console.log('Optimized driver signup script loaded successfully');
</script>
</body>
</html>
