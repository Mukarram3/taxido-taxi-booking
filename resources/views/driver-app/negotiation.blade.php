            ...
            <div class="card">
                ...
                <div class="price-history">
                    <div class="price-history-header">
                        <div class="price-history-title" data-lang="fr" class="active">
                            Historique des propositions
                        </div>
                        <div class="price-history-title" data-lang="en">
                            Offer history
                        </div>

                        <div style="font-size: 13px; color: var(--gray);">
            <span data-lang="fr" class="active">
                {{ count($driver_fare_requests) }} offres échangées
            </span>
                            <span data-lang="en">
                {{ count($driver_fare_requests) }} offers exchanged
            </span>
                        </div>
                    </div>
                    ...
                    <div class="price-timeline">
                        @foreach($driver_fare_requests as $driver_fare_request)
                            ...
                            @php
                                $author = $driver_fare_request->user ?: $driver_fare_request->driver;
                                $isUser = !is_null($driver_fare_request->user);
                                $isLast = $loop->last;
                            @endphp

                            <div class="timeline-item {{ $isLast ? 'active' : '' }}">
                                <div class="timeline-dot {{ $isUser ? 'sender' : 'carrier' }}"></div>
                                ...
                                <div class="timeline-content">
                                    ...
                                    <div class="timeline-left">
                                        <div class="author">
                                            ...
                                            ({{ $isUser ? 'Sender' : 'Carrier' }})
                                        </div>

                                        <div class="amount">
                                            €{{ $driver_fare_request->requested_fare }}
                                        </div>
                                    ...
                                    <div class="timeline-right">
                                        ...
                                        <span class="status {{ $isLast ? 'success' : 'danger' }}">
                    {{ $isLast ? 'In progress' : 'Refused' }}
                </span>
                                    </div>
                ...
                <form action="{{ route('driver.request_fare') }}" method="post">
                    ...
                    <div class="new-offer-form">
                        ...
                        <button type="submit" class="btn btn-warning btn-block">
                            ...
                            <span id="proposal-amount">To propose {{ $userriderequest->fare }}€</span>
                        </button>
                    </div>
...
<script>
    ...
    function setPrice(price) {
        ...
        document.getElementById('proposal-amount').textContent = 'To Propose ' + price + '€';
    }

    document.getElementById('price-input')?.addEventListener('input', function(e) {
        document.getElementById('proposal-amount').textContent = 'To Propose ' + e.target.value + '€';
    });
