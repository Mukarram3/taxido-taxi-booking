...
{{--                    </select>--}}
    ...
    <form method="get" action="{{ route('driver.selact_ride') }}">
            ...
            <ul class="pickup-location-listing" id="location-list">
                <li>
                    <div class="location-box">
                        ...
                        <input type="text" id="pac-input" class="form-control" required placeholder="Airport/Port of Departure" name="pickup_location">
                    </div>
                </li>
                <li>
                    <div class="location-box">
                        ...
                        <input type="text" required id="pac-input2" class="form-control border-0"
                            placeholder="Airport/Port of Arrival" name="destination_location[]">
